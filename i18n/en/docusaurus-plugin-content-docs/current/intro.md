...
The target audience for this series includes friends interested in security and front-end engineers. It is assumed that readers have at least some basic technical knowledge, such as understanding the difference between front-end and back-end and having a basic understanding of HTML, CSS, and JavaScript.
...
I started writing this series because of the [2023 iT Ironman Contest](https://ithelp.ithome.com.tw/2023ironman/event). It is a competition where you need to publish articles continuously for 30 days. That's why this book contains 30 articles. After completing the challenge, I extracted the content and built this website using Docusaurus for easier access to the full content.

## About Me

![](./pics/huli-logo-1080.jpg)

You can refer to my blog directly: https://blog.huli.tw/about/
